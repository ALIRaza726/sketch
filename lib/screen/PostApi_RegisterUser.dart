  ...
  void _register() async {
    ...
    setState(() {
      ...
      if (provider.userData != null) {
        if (provider.userData!.token != null) {
          _message =
              'Registration successful! ID: ${provider.userData!.id}, Token: ${provider.userData!.token}';
        } else {
          _message = 'Registration failed: ${provider.userData!.error}';
        }
      } else {
        _message = 'Registration failed!';
      }
...
class RegisterUserProvider with ChangeNotifier {
  ...
  Future<void> registerUser(String email, String password) async {
    ...
    try {
      ...
      print('Exception: $e');
      _userData = Datum(error: 'Failed to register');
    }
